...
function flojt() {
    ...
    if (b) cornify_add();
        ...
        let c = null;
        c = a.createElement("div"), c.id = "__cornify_nodes", a.getElementsByTagName("body")[0].appendChild(c);
        let d = ["https://cornify.com/js/cornify.js", "https://cornify.com/js/cornify_run.js"];
        for (let e = 0; e < d.length; e++) b = a.createElement("script"), b.src = d[e], c.appendChild(b)
    }
}